        ...
        <div class="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
            ...
            <div class="p-2">
                <div class="border border-black">
                    ...
                    <form action="{{ URL::to('/admin/gejala') }}" method="POST">
                        @csrf
                        <div class="m-4">
                            <div class="flex flex-wrap -mr-0.5 -ml-0.5">
                                <label for="">Kode Gejala</label>
                                <input type="text" name="kode_gejala" class="border border-collapse ml-6">
                            </div>
                            <div class="flex flex-wrap -mr-0.5 -ml-0.5 mt-4">
                                <label for="">Nama Gejala</label>
                                <input type="text" name="nama_gejala" class="border border-collapse ml-5">
                            </div>
